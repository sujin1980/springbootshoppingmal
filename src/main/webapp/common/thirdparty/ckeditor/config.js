...
CKEDITOR.editorConfig = function( config ) {
	  ...
	  //var siteUrl = 'http://'+document.domain+'/';
	    var siteUrl = 'http://localhost:8080/HNUST/';//这是我本地路径，换成你网站的
        //config.filebrowserImageUploadUrl = siteUrl+'static/thirdparty/ckeditor/upload.php?type=img';//upload.php文件的路径
        //config.filebrowserFlashUploadUrl = siteUrl+'admin/ckeditor/upload.php?type=flash';
	    config.filebrowserImageUploadUrl = siteUrl+'fileUpload/upload';
};
